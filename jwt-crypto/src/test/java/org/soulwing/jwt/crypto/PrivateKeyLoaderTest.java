...
/**
 * Unit tests for {@link PrivateKeyLoader}.
 *
 * @author Carl Harris
 */
public class PrivateKeyLoaderTest {
  ...
  public void testLoadDerEncodedRsaKey() throws Exception {
    ...
    final PrivateKey key = PrivateKeyLoader.loadKey(path,
  ...
  public void testLoadInvalidDerRsaContent() throws Exception {
    writeBytes(garbage);
    PrivateKeyLoader.loadKey(path, PublicKeyFormat.DER, PublicKeyType.RSA);
  }

  @Test(expected = InvalidKeySpecException.class)
  public void testLoadInvalidPemRsaContent() throws Exception {
    writePem(garbage);
    PrivateKeyLoader.loadKey(path, PublicKeyFormat.PEM, PublicKeyType.RSA);
  }

  @Test(expected = InvalidKeySpecException.class)
  public void testLoadInvalidDerEcContent() throws Exception {
    writeBytes(garbage);
    PrivateKeyLoader.loadKey(path, PublicKeyFormat.DER, PublicKeyType.EC);
  }

  @Test(expected = InvalidKeySpecException.class)
  public void testLoadInvalidPemEcContent() throws Exception {
    writePem(garbage);
    PrivateKeyLoader.loadKey(path, PublicKeyFormat.PEM, PublicKeyType.EC);
  }

  @Test(expected = IllegalArgumentException.class)
  public void testLoadWhenFileNotFound() throws Exception {
    PrivateKeyLoader.loadKey(Paths.get("some/invalid/path"),
        PublicKeyFormat.DER, PublicKeyType.RSA);
  }
  ...
  private void writePem(byte[] encoded)
    ...
    try (final PemWriter writer = new PemWriter(
      ...
      final String description = "PRIVATE KEY";
