...
import static org.soulwing.jwt.transformer.TransformerLogger.LOGGER;
...
/**
 * A factory that produces {@link ClaimTransformer} objects.
 *
 * @author Carl Harris
 */
public class TransformerFactory {
  ...
  public static Transformer<?, ?> getTransformer(String code, 
    ...
    try {
      ...
      if (transformer instanceof ClaimTransformer) {
        ((ClaimTransformer<?, ?>) transformer).initialize(properties);
      }
