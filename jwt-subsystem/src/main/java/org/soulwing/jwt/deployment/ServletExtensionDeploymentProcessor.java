...
import static org.soulwing.jwt.deployment.DeploymentLogger.LOGGER;
...
import org.soulwing.jwt.extension.Capabilities;
import org.soulwing.jwt.extension.Names;
import org.soulwing.jwt.service.AuthenticationService;
import org.soulwing.jwt.undertow.JwtServletExtension;
...
public class ServletExtensionDeploymentProcessor
  ...
  public void deploy(DeploymentPhaseContext phaseContext) {
    ...
    final ServiceName authServiceName = ServiceName.of(
        ServiceName.parse(Capabilities.CAPABILITY_JWT_PROFILE), config.getProfileId());
