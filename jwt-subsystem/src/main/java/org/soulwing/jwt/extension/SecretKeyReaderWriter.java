...
/**
 * A reader/writer for a {@code secret-key} resource configuration.
 *
 * @author Carl Harris
 */
class SecretKeyReaderWriter extends AbstractResourceReaderWriter {

  public SecretKeyReaderWriter() {
    super(Names.SECRET_KEY);
  }
  ...
  protected SimpleAttributeDefinition[] attributes() {
    return new SimpleAttributeDefinition[] {
        SecretKeyDefinition.KID,
        SecretKeyDefinition.SECRET
    };
  }
