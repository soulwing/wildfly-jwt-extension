...
/**
 * A remove operation handler for the claim transform resource type.
 *
 * @author Carl Harris
 */
class ClaimTransformRemove extends AbstractRemoveStepHandler {

  static final ClaimTransformRemove INSTANCE =
      new ClaimTransformRemove();
  ...
  protected void performRuntime(OperationContext context, ModelNode operation,
    ...
    final ServiceName serviceName =
        ClaimTransformDefinition.CLAIM_TRANSFORM_CAPABILITY.fromBaseCapability(
  ...
  protected void recoverServices(OperationContext context,
    ...
    ClaimTransformAdd.INSTANCE.performRuntime(context, operation, model);
  }
