 ...
 * @author Carl Harris
 */
class ProfileReaderWriter extends AbstractResourceReaderWriter {
  
  public ProfileReaderWriter() {
    super(Names.PROFILE,
        new SecretKeyReaderWriter(),
        new PublicKeyReaderWriter(),
        new ClaimAssertionReaderWriter(),
        new ClaimTransformReaderWriter());
  }

  @Override
  protected SimpleAttributeDefinition[] attributes() {
    return new SimpleAttributeDefinition[] {
        ProfileDefinition.ALGORITHM,
