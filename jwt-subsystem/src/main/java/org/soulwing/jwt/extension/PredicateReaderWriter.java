...
/**
 * A reader/writer for a predicate resource configuration.
 *
 * @author Carl Harris
 */
class PredicateReaderWriter extends AbstractResourceReaderWriter {

  private static final OptionReaderWriter OPTION_RW =
      new OptionReaderWriter(PredicateDefinition.OPTIONS);

  /**
   * Constructs a new instance.
   */
  public PredicateReaderWriter() {
    super(Names.PREDICATE, OPTION_RW);
  }
  ...
  protected SimpleAttributeDefinition[] attributes() {
    return new SimpleAttributeDefinition[] {
        PredicateDefinition.CODE,
        PredicateDefinition.MODULE
    };
  }
