...
/**
 * A remove operation handler for the profile resource type.
 *
 * @author Carl Harris
 */
class ProfileRemove extends AbstractRemoveStepHandler {

  static final ProfileRemove INSTANCE =
      new ProfileRemove();
  ...
  protected void performRuntime(OperationContext context, ModelNode operation,
    ...
    final ServiceName serviceName =
        ProfileDefinition.JWT_PROFILE_CAPABILITY.fromBaseCapability(
  ...
  protected void recoverServices(OperationContext context,
    ...
    ProfileAdd.INSTANCE.performRuntime(context, operation, model);
  }
