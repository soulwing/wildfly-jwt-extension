...
/**
 * A remove operation handler for the claim assertion resource type.
 *
 * @author Carl Harris
 */
class ClaimAssertionRemove extends AbstractRemoveStepHandler {

  static final ClaimAssertionRemove INSTANCE =
      new ClaimAssertionRemove();
  ...
  protected void performRuntime(OperationContext context, ModelNode operation,
    ...
    final ServiceName serviceName =
        ClaimAssertionDefinition.CLAIM_ASSERTION_CAPABILITY.fromBaseCapability(
  ...
  protected void recoverServices(OperationContext context,
    ...
    ClaimAssertionAdd.INSTANCE.performRuntime(context, operation, model);
  }
