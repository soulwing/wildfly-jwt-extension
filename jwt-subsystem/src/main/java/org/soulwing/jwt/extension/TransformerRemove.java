...
/**
 * A remove operation handler for the transformer resource type.
 *
 * @author Carl Harris
 */
class TransformerRemove extends AbstractRemoveStepHandler {
  ...
  protected void performRuntime(OperationContext context, ModelNode operation,
    ...
    final ServiceName serviceName =
        TransformerDefinition.TRANSFORMER_CAPABILITY.fromBaseCapability(
  ...
  protected void recoverServices(OperationContext context,
    ...
    TransformerAdd.INSTANCE.performRuntime(context, operation, model);
  }
