...
/**
 * A remove operation handler for the secret key resource type.
 *
 * @author Carl Harris
 */
class SecretKeyRemove extends AbstractRemoveStepHandler {

  static final SecretKeyRemove INSTANCE = new SecretKeyRemove();
  ...
  protected void performRuntime(OperationContext context, ModelNode operation,
    ...
    final ServiceName serviceName =
        SecretKeyDefinition.SECRET_KEY_CAPABILITY.fromBaseCapability(
  ...
  protected void recoverServices(OperationContext context,
    ...
    SecretKeyAdd.INSTANCE.performRuntime(context, operation, model);
  }
