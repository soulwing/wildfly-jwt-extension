...
/**
 * A remove operation handler for the public key resource type.
 *
 * @author Carl Harris
 */
class PublicKeyRemove extends AbstractRemoveStepHandler {

  static final PublicKeyRemove INSTANCE =
      new PublicKeyRemove();
  ...
  protected void performRuntime(OperationContext context, ModelNode operation,
    ...
    final ServiceName serviceName =
        PublicKeyDefinition.PUBLIC_KEY_CAPABILITY.fromBaseCapability(
  ...
  protected void recoverServices(OperationContext context,
    ...
    PublicKeyAdd.INSTANCE.performRuntime(context, operation, model);
  }
