...
/**
 * Unit tests for {@link ClaimAssertionAdd}.
 *
 * @author Carl Harris
 */
public class ClaimAssertionAddTest {
  ...
  public void setUp() throws Exception {
    operation.set(ModelDescriptionConstants.OP_ADDR,
        PathAddress.pathAddress(Constants.TRANSFORMER,
            "transformer").toModelNode());
  ...
  public void testPerformBoottime() throws Exception {
    context.checking(new Expectations() {
      {
        ...
        oneOf(target).addCapability(with(any(RuntimeCapability.class)),
            with(any(ClaimAssertionService.class)));
    ...
    ClaimAssertionAdd.INSTANCE.performRuntime(operationContext, operation, model);
  }
