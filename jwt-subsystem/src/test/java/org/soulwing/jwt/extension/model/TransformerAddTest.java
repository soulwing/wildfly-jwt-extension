...
/**
 * Unit tests for {@link TransformerAdd}.
 *
 * @author Carl Harris
 */
public class TransformerAddTest {
  ...
  public void testPerformBoottime() throws Exception {
    context.checking(new Expectations() {
      {
        ...
        oneOf(target).addCapability(with(any(RuntimeCapability.class)),
            with(any(TransformerService.class)));
    ...
    TransformerAdd.INSTANCE.performRuntime(operationContext, operation, model);
  }
